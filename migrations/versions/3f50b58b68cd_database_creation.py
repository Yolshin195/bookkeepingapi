...
Revision ID: 3f50b58b68cd
Revises: 
Create Date: 2023-08-28 19:41:02.629855
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_bookkeeping_api_user_email'), 'bookkeeping_api_user', ['email'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_bookkeeping_api_user_email'), table_name='bookkeeping_api_user')
